...
class gsp_torneoBarker_roleindex_gsp extends GroovyPage {
...
invokeTag('link','g',35,['action':("show"),'id':(roleInstance.id)],3)
printHtmlPart(16)
i++
}
}
printHtmlPart(17)
invokeTag('paginate','g',42,['total':(roleInstanceCount ?: 0)],-1)
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1444767581813L
