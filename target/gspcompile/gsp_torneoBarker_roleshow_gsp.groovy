...
class gsp_torneoBarker_roleshow_gsp extends GroovyPage {
...
invokeTag('link','g',38,['class':("edit"),'action':("edit"),'resource':(roleInstance)],3)
printHtmlPart(19)
...
invokeTag('form','g',41,['url':([resource:roleInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1444767581943L
