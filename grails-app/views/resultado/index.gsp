		...
		<div id="list-resultado" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="empate" title="${message(code: 'resultado.empate.label', default: 'Empate')}" />
				...
				<g:each in="${resultadoInstanceList}" status="i" var="resultadoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${resultadoInstance.id}">${fieldValue(bean: resultadoInstance, field: "empate")}</g:link></td>
