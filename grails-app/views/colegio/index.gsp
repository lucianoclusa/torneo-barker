		...
		<div id="list-colegio" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'colegio.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${colegioInstanceList}" status="i" var="colegioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${colegioInstance.id}">${fieldValue(bean: colegioInstance, field: "nombre")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${colegioInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
